...
@clear_screen_loop:
    ...
    lda #0                      ; Initial multiplexer state: Lane 0
    sta g_raster_lane
...
; ==============================================================================
; Raster Interrupt Handler: 3-Lane Multiplexer
; ==============================================================================
; Called via KERNAL IRQ vector ($0314). Kernal $FF48 entry automatically pushes
; A, X, Y onto stack before calling ($0314).
; Multiplexes Hardware Sprites 2, 3, 4 across 3 vertical screen thirds (lanes):
;   Scanline 0:   Lane 0 (Top Third: Enemies 0..2)   -> Next trigger: Line 112
;   Scanline 112: Lane 1 (Middle Third: Enemies 3..5)-> Next trigger: Line 177
;   Scanline 177: Lane 2 (Bottom Third: Enemies 6..8)-> Next trigger: Line 0
; ==============================================================================
raster_irq:
    ...
    ; Multiplexer lane dispatch based on g_raster_lane
    lda g_raster_lane
    bne @check_lane_1

    ; --- Lane 0 (Top Third: Scanline 0) ---
    lda #0
    jsr enemies_render_lane
...
@check_lane_1:
    ...
    ; --- Lane 1 (Middle Third: Scanline 112) ---
    lda #1
    jsr enemies_render_lane
...
@check_lane_2:
    ; --- Lane 2 (Bottom Third: Scanline 177) ---
    lda #2
    jsr enemies_render_lane
