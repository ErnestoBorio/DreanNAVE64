...
"$OSCAR64_BIN" -o=bin/drean_nave_64.prg -tf=prg -g src/main.c src/input.c src/player.c src/sprites_data.c src/gfx_assets.c src/starfield.c src/enemies.c src/collisions.c src/hud.c
